...
bibliography: FUN-01-DGE_comparison_v2_files/DGE_Comp.bib
---
...
data <- read.delim("FUN-01-DGE_comparison_v2_files/RNA_data/GE2_expected_counts_gene.matrix", sep = "\t", header = T, row.names = 1)
