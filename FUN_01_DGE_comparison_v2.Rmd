...
bibliography: FUN_01_DGE_comparison_v2/DGE_Comp.bib
---
...
data <- read.delim("FUN_01_DGE_comparison_v2/RNA_data/GE2_expected_counts_gene.matrix", sep = "\t", header = T, row.names = 1)
...
knitr::include_graphics("FUN_01_DGE_comparison_v2/Rivera_etal_fig.png")
