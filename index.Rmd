...
* [Choosing a population genomics sequencing approach](POP-01-choosing-population-genetics.html)  
* [Whole Genome Resequencing (WGS)](POP-04-WGS_intro.html)  
  * [Low coverage WGS](https://github.com/therkildsen-lab/genomic-data-analysis/blob/master/lcwgs_data_analysis.md)
* [Reduced Representation Sequencing](POP-02-RADseq.html) 
* [Poolseq](POP-03-poolseq.html)
* [Redundancy Analysis (RDA) Trait Prediction](POP-05-RDAtraitPredictionTutorial.html)

#### Functional Genomics  

* [Multifactorial RNAseq analyses](FUN-01-DGE_comparison_v2.html)  
